...
@[ 'unicode-planes' ] = [
  ...
  [ 'Supplementary Special-purpose Plane (SSP)',   0xe0000,  0xefffd, ]
  [ 'Private Use Area (PUA)',                      0xf0000,  0xffffd, ]
  [ 'Private Use Area (PUA)',                     0x100000, 0x10fffd, ]
  ]
...
@[ 'unicode-areas' ] = [
  ...
  [ 'General Scripts Area (RTL)',              0x0590,   0x08ff, ]
  [ 'General Scripts Area',                    0x0900,   0x1fff, ]
  [ 'Punctuation and Symbols Area',            0x2000,   0x2bff, ]
  [ 'General Scripts Area',                    0x2c00,   0x2dff, ]
  [ 'Supplemental Punctuation Area',           0x2e00,   0x2e7f, ]
  [ 'CJK Miscellaneous Area',                  0x2e80,   0x33ff, ]
  [ 'CJKV Unified Ideographs Area',            0x3400,   0x9fff, ]
  [ 'General Scripts Area (Asia & Africa)',    0xa000,   0xabff, ]
  [ 'Hangul Syllables Area',                   0xac00,   0xd7ff, ]
  [ 'Surrogate Codes',                         0xd800,   0xdfff, ]
  [ 'Private Use Area (PUA)',                  0xe000,   0xf8ff, ]
  [ 'Compatibility and Specials Area',         0xf900,   0xffff, ]
  [ 'General Scripts Area',                   0x10000,  0x107ff, ]
  [ 'General Scripts Area (RTL)',             0x10800,  0x10fff, ]
  [ 'General Scripts Area',                   0x11000,  0x11fff, ]
  [ 'Cuneiform & Hieroglyphic Area',          0x12000,  0x15fff, ]
  [ 'General Scripts Area',                   0x16000,  0x16fff, ]
  [ 'Ideographic Scripts Area',               0x17000,  0x1bbff, ]
  [ 'General Scripts Area',                   0x1bc00,  0x1cfff, ]
  [ 'Symbols Area',                           0x1d000,  0x1e7ff, ]
  [ 'General Scripts Area (RTL)',             0x1e800,  0x1efff, ]
