...
(function() {
  var binary_interval_search;

  module.exports = binary_interval_search = function(data, lo_bound_key, hi_bound_key, id_key, probe) {
     ...
     */
    var hi_bound, hi_idx, id_and_range, lo_bound, lo_idx, mid_idx;
    lo_idx = 0;
    ...
    while (lo_idx <= hi_idx) {
      ...
      if ((lo_bound <= probe && probe <= hi_bound)) {
        if (id_key != null) {
          return id_and_range[id_key];
        } else {
          return mid_idx;
        }
      }
...
//# sourceMappingURL=binary-interval-search.js.map
