...
(function() {
  ...
  this["Unicode demo"] = function(T) {
    var ISL, XNCR, cid, cid_hex, csg, description, descriptions, glyph, hi, i, is_cjk, is_cjk_glyph, is_cjk_rsg, j, k, last_cid, len, len1, len2, lo, mkts_options, name, range, ranges, ref, ref1, ref2, rsg, rsg_registry, style, unicode_areas;
    XNCR = require('./xncr');
    ...
    ref1 = mkts_options['tex']['glyph-styles'];
    for (glyph in ref1) {
      style = ref1[glyph];
      ...
      cid_hex = hex(cid);
      name = "glyph-" + cid_hex;
      ISL.add_interval(unicode_areas, cid, cid, name, {
        name: name,
        lo: lo,
        hi: hi,
        rsg: rsg,
    ...
    ref2 = Array.from("helo äöü你好𢕒𡕴𡕨𠤇𫠠𧑴𨒡《》【】");
    for (j = 0, len1 = ref2.length; j < len1; j++) {
      ...
      urge(glyph, cid_hex);
      for (k = 0, len2 = descriptions.length; k < len2; k++) {
