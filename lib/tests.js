...
(function() {
  var CND, NCR, alert, badge, debug, echo, help, hex, i, include, info, key, len, log, ref, rpr, test, urge, warn, whisper,
  ...
  this["(v2) create derivatives of NCR (1)"] = function(T) {
    ...
    T.ok(NCR._unicode_isl != null);
    T.ok(XNCR._unicode_isl !== NCR._unicode_isl);
    ...
    XNCR._ISL.add(XNCR._unicode_isl, {
      lo: 0x00,
      hi: 0xff,
      rsg: 'u-foobar'
    });
