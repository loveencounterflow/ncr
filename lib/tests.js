...
(function() {
  ...
  this["Unicode demo"] = function(T) {
    var ISL, XNCR, _, add_plane, cid, cid_hex, csg, description, descriptions, glyph, hi, i, id, is_cjk, is_cjk_glyph, is_cjk_rsg, j, k, key, l, last_cid, len, len1, len2, len3, line, lo, mkts_options, name, range, ranges, ref, ref1, ref2, ref3, ref4, ref5, ref6, rsg, rsg_registry, source, style, tex, tex_command_by_rsgs, type, unicode_areas, value;
    XNCR = require('./xncr');
    ...
    add_plane = function(isl, name, lo, hi) {
      ...
      type = 'plane';
      id = type + "/" + name;
      return ISL.add_interval(isl, lo, hi, id, {
        id: id,
        type: type,
        name: name,
        lo: lo,
    ...
    for (csg in ref) {
      ...
      for (i = 0, len = ranges.length; i < len; i++) {
        ...
        tex = (ref1 = tex_command_by_rsgs[rsg]) != null ? ref1 : tex_command_by_rsgs['fallback'];
        type = 'block';
        id = type + "/" + name;
        ISL.add_interval(unicode_areas, lo, hi, id, {
          id: id,
          type: type,
          name: name,
          lo: lo,
    ...
    for (glyph in ref2) {
      ...
      type = 'style';
      id = type + "/" + name;
      ISL.add_interval(unicode_areas, cid, cid, id, {
        id: id,
        type: type,
        name: name,
        lo: lo,
