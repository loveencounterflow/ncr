...
(function() {
  ...
  this["Unicode demo"] = function(T) {
    var ISL, XNCR, _, add_plane, cid, cid_hex, csg, description, descriptions, glyph, hi, i, is_cjk, is_cjk_glyph, is_cjk_rsg, j, k, key, l, last_cid, len, len1, len2, len3, line, lo, mkts_options, name, range, ranges, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, rsg, rsg_registry, source, style, tex, tex_command_by_rsgs, type, u, value;
    XNCR = require('./xncr');
