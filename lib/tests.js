...
(function() {
  ...
  this._Unicode_demo_add_planes = function(isl) {
    var ISL, csg, hi, i, len, lo, name, range, ranges, ref, rsg, rsg_registry, short_name, type;
    ISL = require('interskiplist');
  ...
  this._Unicode_demo_add_areas = function(isl) {
    var ISL, _, hi, i, len, line, lo, name, ref, ref1, short_name, source, type;
    ISL = require('interskiplist');
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      ref1 = line.match(/^([0-9a-fA-F]{4,5})-([0-9a-fA-F]{4,5}) (.+)$/), _ = ref1[0], lo = ref1[1], hi = ref1[2], short_name = ref1[3];
      lo = parseInt(lo, 16);
      hi = parseInt(hi, 16);
      type = 'area';
      name = type + ":" + short_name;
  ...
  this._Unicode_demo_add_cjk_tags = function(isl) {
    var ISL, hi, lo, range, ranges, rsg, rsg_registry, tag, tag_by_rsgs;
    ISL = require('interskiplist');
    tag_by_rsgs = {
      'u-cjk': ['cjk'],
      'u-halfull': ['cjk'],
  ...
  this["Unicode demo"] = function(T) {
    ...
    this._Unicode_demo_add_areas(u);
