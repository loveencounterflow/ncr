...
(function() {
  var CND, ISL, alert, badge, character_sets_and_ranges, debug, dec, decG, echo, help, hex, hexG, info, log, name, nameO, nameOG, rpr, unicode_isl, urge, warn, whisper;
  ...
  this._as_rsg = function(csg, cid) {
    ...
    if (csg !== 'u') {
      throw new Error("only Unicode supported at this time, got CSG " + (rpr(csg)));
    }
    if (ISL == null) {
