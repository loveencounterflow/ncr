...
(function() {
  ...
  this._as_rsg = function(csg, cid) {
    ...
    return (ref = (this._ISL.aggregate(this.unicode_isl, cid))['rsg']) != null ? ref : csg;
  };
  ...
  this._as_range_name = function(csg, cid) {
    ...
    return (ref = (this._ISL.aggregate(this.unicode_isl, cid))['block']) != null ? ref : this._as_rsg(csg, cid);
  };
