...
(function() {
  var CND, alert, badge, binary_interval_search, character_sets_and_ranges, debug, dec, decG, echo, help, hex, hexG, info, log, name, nameO, nameOG, rpr, urge, warn, whisper;
  ...
  this._ranges_by_rsg = character_sets_and_ranges['ranges-by-rsg'];
  ...
  this.chrs_from_text = function(text, options) {
    ...
    switch (input_mode = (ref = options != null ? options['input'] : void 0) != null ? ref : 'plain') {
      case 'plain':
  ...
  this.chunks_from_text = function(text, options) {
    ...
    last_rsg = null;
    chrs = [];
    switch (output_mode = (ref = options != null ? options['output'] : void 0) != null ? ref : 'plain') {
      case 'plain':
    ...
    ref1 = this.chrs_from_text(text, options);
  ...
  this.html_from_text = function(text, options) {
    var R, chunk, chunks, i, input_mode, len, ref;
    R = [];
    input_mode = (ref = options != null ? options['input'] : void 0) != null ? ref : 'plain';
  ...
  this.cid_range_from_rsg = function(rsg) {
    var R;
    if ((R = this._ranges_by_rsg[rsg]) == null) {
