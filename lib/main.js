...
(function() {
  var CND, ISL, alert, badge, debug, dec, decG, echo, help, hex, hexG, info, log, name, nameO, nameOG, rpr, unicode_isl, urge, warn, whisper;
  ...
  this._as_rsg = function(csg, cid) {
    ...
    return (ref = (ISL.aggregate(unicode_isl, cid))['rsg']) != null ? ref : csg;
  };
  ...
  this._as_range_name = function(csg, cid) {
    ...
    return (ref = (ISL.aggregate(unicode_isl, cid))['block']) != null ? ref : this._as_rsg(csg, cid);
  };
