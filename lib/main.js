...
(function() {
  ...
  this._unicode_isl = null;

  this._get_unicode_isl = function() {
    var i, interval, len, ref;
    if (this._unicode_isl != null) {
      return this._unicode_isl;
    }
    if (this._ISL == null) {
      this._ISL = require('interskiplist');
    }
    this._unicode_isl = this._ISL["new"]();
    this._ISL.add_index(this._unicode_isl, 'rsg');
    this._ISL.add_index(this._unicode_isl, 'tag');
    ref = require('../data/unicode-9.0.0-intervals.json');
    for (i = 0, len = ref.length; i < len; i++) {
      interval = ref[i];
      this._ISL.add(this._unicode_isl, interval);
    }
    return this._unicode_isl;
  };
  ...
  this._as_rsg = function(csg, cid) {
    ...
    this._get_unicode_isl();
    return (ref = (this._ISL.aggregate(this._unicode_isl, cid))['rsg']) != null ? ref : csg;
  };
  ...
  this._as_range_name = function(csg, cid) {
    ...
    this._get_unicode_isl();
    return (ref = (this._ISL.aggregate(this._unicode_isl, cid))['block']) != null ? ref : this._as_rsg(csg, cid);
  };
  ...
  this.validate_is_cid = function(x) {
    ...
    if (x < 0x000000 || x > 0x10ffff || (parseInt(x)) !== x) {
